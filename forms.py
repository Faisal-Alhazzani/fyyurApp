...
class VenueForm(Form):
    ...
    phone = StringField(
        'phone', validators=[Regexp("^[0-9]*$", message="Kindly, enter a valid phone number")]
    )
...
class ArtistForm(Form):
    ...
    phone = StringField(
        # Completed: implement validation logic for state
        'phone', validators=[DataRequired(), Regexp("^[0-9]*$", message="Kindly, enter a valid phone number")]
    )
    image_link = StringField(
        'image_link'
    )
